...
export class Slideshow extends Component {
  ...
  #handleMouseDown = (event) => {
    ...
    // Skip interactive elements so selects, buttons, and inputs keep native behavior
    // (e.g. product-card variant dropdowns and quick-add inside carousels)
    if (
      event.target.closest(
        'model-viewer, select, option, input, textarea, button, label, a, summary, [role="button"], swatches-variant-picker-component, .variant-option__select-wrapper'
      )
    ) {
